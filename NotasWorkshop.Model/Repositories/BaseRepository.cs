...
namespace SicopataPedidos.Model.Repositories
{
    public class BaseRepository<T> : IRepository<T> where T : class, IBaseEntity
    {
        public readonly IUnitOfWork<ISicopataPedidosDbContext> _uow;
        public readonly ISicopataPedidosDbContext _context;
        public readonly DbSet<T> _dbSet;

        public BaseRepository(IUnitOfWork<ISicopataPedidosDbContext> uow)
        {
            _uow = uow;
